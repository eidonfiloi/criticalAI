...
params = {
    'network_shape': [1024, 600, 400, 300, 200, 10],
    'activation_function': tf.nn.relu,
    'optimizer': tf.train.AdamOptimizer(learning_rate=1e-4),
    'tensorboard_dir': 'models/tensorboard_cmnet',
    'batch_size': 100,
    'activation_pattern_layers': ['layer_1', 'layer_2', 'layer_3', 'layer_4'],
    'layers_with_start': [0]
}
...
model = CriticalEchoMirrorNet(params, hidden_weights=hidden_weight_dict)
